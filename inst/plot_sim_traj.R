...
pars=c(1E-15*exp(-1.35),4.10,0.41,0.92,-1.83,-2.08) #delta, log(q), log(alpha0),log(beta0),log(-alpha1),log(-beta1)
...
plot(N[1,],ylim=c(0,250000),type="l",lwd=1.2,cex.axis=1.3,cex.lab=1.3,xlab="Simulation year",ylab="SSL (Numbers)")
